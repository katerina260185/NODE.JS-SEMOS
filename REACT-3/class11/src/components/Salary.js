...
import { depositBalance, depositBalanceAsync } from "../redux/actions/balanceActions";
...
export const Salary = ()=>{
    ...
    return(
      ...
      <button onClick={() => dispatch(depositBalance(currentBalance))}>
        ...
        <button onClick={()=>dispatch(depositBalanceAsync(monthlySallary))}>Add my monthly sallary after some time</button>
        </div>
